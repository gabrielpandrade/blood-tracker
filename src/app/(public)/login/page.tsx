    ...
    <div className="min-h-screen relative overflow-hidden bg-[#0a0a0a]">
      ...
      <div className="absolute inset-0 opacity-20">
        {[
          ...
          { delay: "1s", duration: "15s", x: "85%", y: "30%" },
          { delay: "3s", duration: "11s", x: "50%", y: "50%" },
        ].map((cell, i) => (
          <div
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div className="inline-flex items-center justify-center mb-4">
            <div className="relative">
              <div className="w-20 h-20 rounded-full bg-linear-to-br from-red-600 to-red-800 flex items-center justify-center shadow-[0_0_40px_rgba(220,38,38,0.6)] animate-pulse-slow">
          ...
          <h1 className="text-4xl font-bold bg-linear-to-r from-red-400 via-red-500 to-red-600 bg-clip-text text-transparent mb-2 tracking-tight">
            Blood Tracker
          </h1>
        </div>
        ...
        <div className="w-full max-w-sm">
          <div className="bg-zinc-900/80 backdrop-blur-xl border border-red-900/30 rounded-2xl p-8 shadow-2xl animate-slide-up">
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input
                          ...
                          className="bg-zinc-950/50 border-red-900/40 text-white placeholder:text-zinc-500 focus-visible:border-red-500 focus-visible:ring-red-500/20 transition-all duration-300 h-12"
                          disabled={isLoading}
                          {...field}
                        />
                      </FormControl>
            ...
            {/* <div className="mt-6 text-center">
              <button
                type="button"
                className="text-red-300/70 hover:text-red-300 text-sm transition-colors duration-200"
              >
                Esqueceu sua senha?
              </button>
            </div> */}
